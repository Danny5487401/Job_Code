...
# ---------------------------------------- Pretty Split Line ----------------------------------------
class InterviewSub_Phone_Call_Log(models.Model):
    #interview = models.ForeignKey(Interview, on_delete=models.CASCADE)
    ...
    ringduration = models.IntegerField(null=True)   
   

    createtime = models.DateTimeField(blank=True, null=True)
    callid = models.CharField(max_length=1000, blank=True, null=True)
    ...
    localphone = models.CharField(max_length=50, null=True, blank=True)
    mark = models.CharField(max_length=1000, blank=True, null=True)
    classify = models.CharField(max_length=1000, blank=True, null=True)
    ...
    to_phone = models.BooleanField(default=0)
...
class Interview_Count(models.Model):
    post_id = models.IntegerField(null=False)
    status = models.IntegerField(null=False)
    sl = models.IntegerField(null=False)  
    sub_status = models.CharField(max_length=500, null=True, blank=True)
