...
urlpatterns = [
    ...
    path('libs/', interviewsViews.LibsTable.as_view(), name='t_libs'),
    ...
    path('multi/test', views.callInterview, name='t_callInterview'),
    ...
    path('resumes/<int:pk>/add/', resumesViews.ResumeDetailInfo, name='t_resume_add'),
    path('posts/', companiesViews.PostTable.as_view(), name='t_posts'),   #发布岗位
]
